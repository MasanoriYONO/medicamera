...
var saved_photo_directory = "net.masanoriyono.monaca.emgcamera";
var image_tag = "";
var photo_div = "";
var saved_date = "";
var array_picture = [];
...
var image_directory = "";
var view_title = "";
var p_db = window.openDatabase("monaca_emgcamera", "1.0", "monaca_emgcamera", 24 * 1024 * 1024);
...
function camera_removeImageFile(){
    ...
    window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, camera_gotDIR_R_removeImage, camera_fail);
}

function camera_gotDIR_R_removeImage(fileSystem) {
    console.log("camera_gotDIR_R_removeImage.");
    
    fileSystem.root.getDirectory(saved_photo_directory, {create: false}, camera_gotFS_R_removeImage, camera_fail);
...
function camera_gotFS_R_removeImage(dirEntry) {
    ...
    dirEntry.getFile(remove_photo_filename, {create: false}, camera_gotFileEntry_R_removeImage, camera_fail);
}
        
function camera_gotFileEntry_R_removeImage(fileEntry) {
    console.log("camera_gotFileEntry_R_removeImage.");
    
    fileEntry.remove(camera_gotFile_removeImage, camera_fail);
}
