 ...
 * PictureList class
 */
var EmgList = (function() {
    
    var EmgList = function(options) {
        //Mask element
        // this.maskEl = "#mask";
     ...
     */
    EmgList.prototype.load = function() {
        var self = this;
    ...
    EmgList.prototype.addClickHandler = function() {
    ...
    EmgList.prototype.escape = function(string) {
